...
if(isset($_POST['add_product'])){
    ...
    $insert_stat_product = "INSERT INTO `products` (`artisan_id`, `name`, `descreption`, `price`, `category_id`, `image`) VALUES (".$_SESSION['artisan_id'].",'$name', '$descreption' , '$price','$category', '$image_name')";
