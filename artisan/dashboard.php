                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="card text-white  bg-primary text-center">
                                                        <div class="card-header pt-2 pb-1">
                                                            <i class="la la-check mb-1 fa-2x"  aria-hidden="true"></i>
                                                            <h4 class="card-title text-white">Accepted orders</h4>                                
                                                        </div>
                                                        <div class="card-content pt-0 pb-2 collapse show">
                                                            <div class="card-body p-0">
                                                                <h4 class="mb-0 text-white"><?php echo $ordersCount['total_orders'] ?></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="card text-white  bg-warning text-center">
                                                        ...
                                                        <div class="card-content pt-0 pb-2 collapse show">
                                                            ...
                                                            <?php if($profitPlus['total_profit'] == null) { ?>
                                                                <h4 class="mb-0 text-white">0 LE</h4>

                                                                <?php }else{ ?>
                                                                <h4 class="mb-0 text-white"><?php echo $profitPlus['total_profit'] ?> LE</h4>
                                                                <?php } ?>
                                                            </div>
                                                        </div>
                                                    </div>
