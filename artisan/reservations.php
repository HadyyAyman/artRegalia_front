                                ...
                                <div class="card-content collapse show">
                                    ...
                                    <?php if(isset($success)){ ?>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="POST">
                                                        ...
                                                        <?php if ($result["artisan_status"] == 'pending') {?>
                                                        <button class="btn btn-success" 
                                                        type="button"
                                                        data-toggle="modal" data-target="#accept_confirmation<?php echo $result['id'] ?>"">Accept</button>
                                                        <?php } ?>
                                                    </form>
                                            </td>
                                            ...
                                            <div id="accept_confirmation<?php echo $result['id'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="my-modal-title">Confirm reservation</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="submit" name="accept_reservation" class="btn btn-primary">Confirm reservation</button>
