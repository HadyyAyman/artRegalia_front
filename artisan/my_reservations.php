            ...
            <div class="content-body">
                ...
                <section id="dom">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header bg-primary bg-darken-2 white text-center card-title-bold text-capitalize">My Reservations</div>
                                <div class="card-content collapse show">
                                    ...
                                    <?php if(isset($success)){ ?>
                                        ...
                                        <tbody>
                                            ...
                                            WHERE reservations.artisan_id = ".$_SESSION['artisan_id']." AND reservations.user_status = 'accepted'
