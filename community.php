...
<?php include "includes/head.php"; ?>
  ...
  <main class="com-container">
    ...
    <div id="featuredCarousel"
      class="carousel comm-carousel post-slide p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary"
      ...
      <button class="carousel-control-prev post-carousel-control-prev" type="button" data-bs-target="#featuredCarousel"
        data-bs-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
      </button>
      <button class="carousel-control-next post-carousel-control-next" type="button" data-bs-target="#featuredCarousel"
        data-bs-slide="next">
    ...
    <div class="col-12 d-flex justify-content-center">
      <div class="col-md-4 mb-4 ">
        ...
        <input type="text" class="form-control blog-search" placeholder=" Blog Search ">
        <button class="btn btn-outline-secondary blog-srch-btn" type="button" id="button-addon2">
        ...
        <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
          ...
          <div class="col-auto d-none d-lg-block">
            <svg class="bd-placeholder-img" width="200" height="100%" xmlns="http://www.w3.org/2000/svg" role="img"
              ...
              <!-- Button to create a post (only visible to admin, artist, and craftsman) -->
        <?php if (isset($_SESSION['user_type']) && in_array($_SESSION['user_type'], ['admin', 'artist', 'craftsman'])): ?>
          <form action="create_post.php" method="GET" style="display:inline;">  
          <button id="createPostBtn" class="btn-circle floating-btn"><i class="ri-quill-pen-line"></i></button>
        </form>
          <?php endif; ?>
        ...
        <div class="text-center blog-container">
          <div class="row mb-4 justify-content-center">
            <div class="col-12 col-md-4">
              <img src="https://r.mobirisesite.com/463604/assets/images/photo-1621194327164-62ec8d09775c.jpeg"
