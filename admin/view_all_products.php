                    ...
                    <table id="requests-table">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <button class="btn-header" type="submit" name="sort_column" value="user_id">Product ID <i class="fa-solid fa-sort"></i></button>
                                    <input type="hidden" name="sort_order" value="">
                                </th>
                                <th>
                                    <button class="btn-header" type="submit" name="sort_column" value="user_lastname">Artisan ID <i class="fa-solid fa-sort"></i></button>
                                </th>
                                <th>
                                    <button class="btn-header" type="submit" name="sort_column" value="user_address">Category ID <i class="fa-solid fa-sort"></i></button>
                                </th>
                                <th>
                                    <button class="btn-header" type="submit" name="sort_column" value="user_gender">Price <i class="fa-solid fa-sort"></i></button>
                                </th>
                                <th>
                                    <button class="btn-header" type="submit" name="sort_column" value="user_email">Product Time <i class="fa-solid fa-sort"></i></button>
                                </th>
                                <th>
                                    <button class="btn-header" type="submit" name="sort_column" value="username">Product Description <i class="fa-solid fa-sort"></i></button>
                                </th>
                                <th>
                                    <button class="btn-header" type="submit" name="sort_column" value="user_phone">Colors <i class="fa-solid fa-sort"></i></button>
                                </th>
                                <th>
                                    <button class="btn-header" type="submit" name="sort_column" value="user_firstname">Product Dimensions<i class="fa-solid fa-sort"></i></button>
                                </th>
                                <th>Edit</th>
                                <th>Delete</th>
                            </tr>
