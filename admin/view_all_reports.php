...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form class="admin_table" method="POST" action="">
                    ...
                    <table id="requests-table">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <button class="btn-header" type="submit" name="sort_column" value="">Report ID <i class="fa-solid fa-sort"></i></button>
                                ...
                                <th>
                                    <button class="btn-header" type="submit" name="sort_column" value="">Report Date <i class="fa-solid fa-sort"></i></button>
                                </th>
                                <th>Edit</th>
                                <th>Delete</th>
                            </tr>
