                ...
                <div class="card-header text-white bg-primary bg-darken-2 white text-center card-title-bold text-capitalize">Orders</div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                $orders = "SELECT * FROM `orders` WHERE statues != 'in_cart'";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($result['statues'] == 'submitted') { ?>
                                                <form method="POST">
                                                    <input type="hidden" name="order_id" value="<?php echo $result['id'] ?>">
                                                    <button type="submit" name="accept_order" class="btn btn-success" onclick="return confirm('Are you need to accept #<?php echo $result['id'] ?>');">Accept</button>
